...
theme_linedraw(base_size = base_size) + 
  theme(
    ...
    axis.line = element_line(colour = "black", linewidth= 3.4),
    axis.ticks = element_line(colour = "black", linewidth = 3.4),
    axis.ticks.length = unit(0.5, "cm"),
    panel.border = element_rect(linewidth = 3.5, fill = NA),
    panel.spacing = unit(0.8, "lines"),
    panel.grid.minor = element_line(colour = "grey90", linewidth = 1),
    panel.grid.major = element_line(colour = "grey90", linewidth = 0.5),
    strip.background = element_rect(fill = "grey80", colour = "black", linewidth = 5),
