...
theme_linedraw(base_size = base_size) + 
  theme(
    ...
    axis.ticks = element_line(colour = "black", linewidth = 3.0),
    axis.ticks.length = unit(0.5, "cm"),
    panel.border = element_rect(linewidth = 2.8, fill = NA),
    panel.spacing = unit(0.8, "lines"),
    panel.grid.minor = element_line(colour = "grey90", linewidth = 0.5),
    panel.grid.major = element_line(colour = "grey90", linewidth = 0.2),
    strip.background = element_rect(fill = "grey80", colour = "black", linewidth = 3.5),
